...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.params.v1beta1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z4github.com/cosmos/cosmos-sdk/x/params/types/proposal'
    )
    ...
    _QUERY.methods_by_name[
        ...
        b'\202\323\344\223\002\037\022\035/cosmos/params/v1beta1/params'
    )
    _QUERY.methods_by_name['Subspaces']._options = None
    _QUERY.methods_by_name[
        'Subspaces'
    ]._serialized_options = (
        b'\202\323\344\223\002\"\022 /cosmos/params/v1beta1/subspaces'
    )
