...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.group.v1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name[
        ...
        b'\202\323\344\223\002(\022&/cosmos/group/v1/group_info/{group_id}'
    )
    _QUERY.methods_by_name['GroupPolicyInfo']._options = None
    _QUERY.methods_by_name[
        'GroupPolicyInfo'
    ]._serialized_options = (
        b'\202\323\344\223\002.\022,/cosmos/group/v1/group_policy_info/{address}'
    )
    _QUERY.methods_by_name['GroupMembers']._options = None
    _QUERY.methods_by_name[
        'GroupMembers'
    ]._serialized_options = (
        b'\202\323\344\223\002+\022)/cosmos/group/v1/group_members/{group_id}'
    )
    _QUERY.methods_by_name['GroupsByAdmin']._options = None
    _QUERY.methods_by_name[
        'GroupsByAdmin'
    ]._serialized_options = (
        b'\202\323\344\223\002*\022(/cosmos/group/v1/groups_by_admin/{admin}'
    )
    _QUERY.methods_by_name['GroupPoliciesByGroup']._options = None
    _QUERY.methods_by_name[
        'GroupPoliciesByGroup'
    ]._serialized_options = (
        b'\202\323\344\223\0025\0223/cosmos/group/v1/group_policies_by_group/{group_id}'
    )
    _QUERY.methods_by_name['GroupPoliciesByAdmin']._options = None
    _QUERY.methods_by_name[
        'GroupPoliciesByAdmin'
    ]._serialized_options = (
        b'\202\323\344\223\0022\0220/cosmos/group/v1/group_policies_by_admin/{admin}'
    )
    _QUERY.methods_by_name['Proposal']._options = None
    _QUERY.methods_by_name[
        'Proposal'
    ]._serialized_options = (
        b'\202\323\344\223\002)\022\'/cosmos/group/v1/proposal/{proposal_id}'
    )
    _QUERY.methods_by_name['ProposalsByGroupPolicy']._options = None
    _QUERY.methods_by_name[
        'ProposalsByGroupPolicy'
    ]._serialized_options = b'\202\323\344\223\0026\0224/cosmos/group/v1/proposals_by_group_policy/{address}'
    _QUERY.methods_by_name['VoteByProposalVoter']._options = None
    _QUERY.methods_by_name[
        'VoteByProposalVoter'
    ]._serialized_options = b'\202\323\344\223\002?\022=/cosmos/group/v1/vote_by_proposal_voter/{proposal_id}/{voter}'
    _QUERY.methods_by_name['VotesByProposal']._options = None
    _QUERY.methods_by_name[
        'VotesByProposal'
    ]._serialized_options = (
        b'\202\323\344\223\0022\0220/cosmos/group/v1/votes_by_proposal/{proposal_id}'
    )
    _QUERY.methods_by_name['VotesByVoter']._options = None
    _QUERY.methods_by_name[
        'VotesByVoter'
    ]._serialized_options = (
        b'\202\323\344\223\002)\022\'/cosmos/group/v1/votes_by_voter/{voter}'
    )
    _QUERY.methods_by_name['GroupsByMember']._options = None
    _QUERY.methods_by_name[
        'GroupsByMember'
    ]._serialized_options = (
        b'\202\323\344\223\002-\022+/cosmos/group/v1/groups_by_member/{address}'
    )
    _QUERY.methods_by_name['TallyResult']._options = None
    _QUERY.methods_by_name[
        'TallyResult'
    ]._serialized_options = (
        b'\202\323\344\223\0020\022./cosmos/group/v1/proposals/{proposal_id}/tally'
    )
    _QUERY.methods_by_name['Groups']._options = None
    _QUERY.methods_by_name[
        'Groups'
    ]._serialized_options = b'\202\323\344\223\002\031\022\027/cosmos/group/v1/groups'
