...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGCREATEGROUP.fields_by_name[
        'admin'
    ...
    _MSGUPDATEGROUPMEMBERS._serialized_options = (
    ...
    _MSGUPDATEGROUPADMIN.fields_by_name[
        'admin'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _MSGUPDATEGROUPADMIN._serialized_options = (
    ...
    _MSGUPDATEGROUPMETADATA.fields_by_name[
        'admin'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _MSGUPDATEGROUPMETADATA._options = None
    _MSGUPDATEGROUPMETADATA._serialized_options = (
    ...
    _MSGCREATEGROUPPOLICY.fields_by_name[
        'admin'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _MSGCREATEGROUPPOLICYRESPONSE.fields_by_name[
        'address'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _MSGUPDATEGROUPPOLICYADMIN.fields_by_name['admin']._options = None
    _MSGUPDATEGROUPPOLICYADMIN.fields_by_name[
        'admin'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _MSGUPDATEGROUPPOLICYADMIN._serialized_options = (
    ...
    _MSGCREATEGROUPWITHPOLICY.fields_by_name[
        'admin'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _MSGCREATEGROUPWITHPOLICYRESPONSE.fields_by_name[
        'group_policy_address'
    ]._options = None
    _MSGCREATEGROUPWITHPOLICYRESPONSE.fields_by_name[
        'group_policy_address'
    ...
    _MSGUPDATEGROUPPOLICYDECISIONPOLICY.fields_by_name[
        'admin'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _MSGUPDATEGROUPPOLICYDECISIONPOLICY.fields_by_name[
        'group_policy_address'
    ...
    _MSGUPDATEGROUPPOLICYMETADATA.fields_by_name[
        'admin'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _MSGUPDATEGROUPPOLICYMETADATA._serialized_options = (
    ...
    _MSGWITHDRAWPROPOSAL.fields_by_name[
        'address'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _MSGWITHDRAWPROPOSAL._options = None
    _MSGWITHDRAWPROPOSAL._serialized_options = (
    ...
    _MSGVOTE._serialized_options = (
        b'\202\347\260*\005voter\212\347\260*\030cosmos-sdk/group/MsgVote'
    )
    _MSGEXEC.fields_by_name['executor']._options = None
    _MSGEXEC.fields_by_name[
        'executor'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _MSGEXEC._options = None
    _MSGEXEC._serialized_options = (
        b'\202\347\260*\006signer\212\347\260*\030cosmos-sdk/group/MsgExec'
    )
    _MSGLEAVEGROUP.fields_by_name['address']._options = None
    _MSGLEAVEGROUP.fields_by_name[
        'address'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _MSGLEAVEGROUP._options = None
    _MSGLEAVEGROUP._serialized_options = (
