...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.authz.v1beta1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYGRANTSREQUEST.fields_by_name[
        'granter'
    ...
    _QUERYGRANTERGRANTSREQUEST.fields_by_name[
        'granter'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _QUERYGRANTEEGRANTSREQUEST.fields_by_name['grantee']._options = None
    _QUERYGRANTEEGRANTSREQUEST.fields_by_name[
        'grantee'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _QUERY.methods_by_name[
        ...
        b'\202\323\344\223\0020\022./cosmos/authz/v1beta1/grants/granter/{granter}'
    )
    _QUERY.methods_by_name['GranteeGrants']._options = None
    _QUERY.methods_by_name[
        'GranteeGrants'
    ]._serialized_options = (
        b'\202\323\344\223\0020\022./cosmos/authz/v1beta1/grants/grantee/{grantee}'
    )
