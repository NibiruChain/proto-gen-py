...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.authz.v1beta1.tx_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z$github.com/cosmos/cosmos-sdk/x/authz\310\341\036\000'
    )
    _MSGGRANT.fields_by_name['granter']._options = None
    _MSGGRANT.fields_by_name[
        'granter'
    ...
    _MSGGRANT._serialized_options = (
        b'\202\347\260*\007granter\212\347\260*\023cosmos-sdk/MsgGrant'
    )
    ...
    _MSGEXEC.fields_by_name[
        'msgs'
    ]._serialized_options = b'\312\264-\027cosmos.base.v1beta1.Msg'
    _MSGEXEC._options = None
    _MSGEXEC._serialized_options = (
        b'\202\347\260*\007grantee\212\347\260*\022cosmos-sdk/MsgExec'
    )
    _MSGREVOKE.fields_by_name['granter']._options = None
    _MSGREVOKE.fields_by_name[
        'granter'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _MSGREVOKE._serialized_options = (
        b'\202\347\260*\007granter\212\347\260*\024cosmos-sdk/MsgRevoke'
    )
    _MSG._options = None
