...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.evidence.v1beta1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYEVIDENCEREQUEST.fields_by_name[
        ...
        b'\030\001\372\336\0370github.com/cometbft/cometbft/libs/bytes.HexBytes'
    )
    _QUERY.methods_by_name['Evidence']._options = None
    _QUERY.methods_by_name[
        'Evidence'
    ]._serialized_options = (
        b'\202\323\344\223\002*\022(/cosmos/evidence/v1beta1/evidence/{hash}'
    )
    _QUERY.methods_by_name['AllEvidence']._options = None
    _QUERY.methods_by_name[
        'AllEvidence'
    ]._serialized_options = (
        b'\202\323\344\223\002#\022!/cosmos/evidence/v1beta1/evidence'
    )
