...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.feegrant.v1beta1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYALLOWANCEREQUEST.fields_by_name[
        'granter'
    ...
    _QUERYALLOWANCESREQUEST.fields_by_name[
        'grantee'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _QUERYALLOWANCESBYGRANTERREQUEST.fields_by_name['granter']._options = None
    _QUERYALLOWANCESBYGRANTERREQUEST.fields_by_name[
        'granter'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    ...
    _QUERY.methods_by_name[
        ...
        b'\202\323\344\223\002/\022-/cosmos/feegrant/v1beta1/allowances/{grantee}'
    )
    _QUERY.methods_by_name['AllowancesByGranter']._options = None
    _QUERY.methods_by_name[
        'AllowancesByGranter'
    ]._serialized_options = (
        b'\202\323\344\223\002+\022)/cosmos/feegrant/v1beta1/issued/{granter}'
    )
