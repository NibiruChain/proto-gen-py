...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.bank.v1beta1.bank_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PARAMS._serialized_options = (
        b'\230\240\037\000\212\347\260*\030cosmos-sdk/x/bank/Params'
    )
    ...
    _INPUT._serialized_options = (
        b'\210\240\037\000\350\240\037\000\202\347\260*\007address'
    )
    ...
    _METADATA.fields_by_name[
        'uri_hash'
    ]._serialized_options = b'\342\336\037\007URIHash'
