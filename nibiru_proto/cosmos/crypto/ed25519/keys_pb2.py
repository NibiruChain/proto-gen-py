...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.crypto.ed25519.keys_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z0github.com/cosmos/cosmos-sdk/crypto/keys/ed25519'
    )
    _PUBKEY.fields_by_name['key']._options = None
    _PUBKEY.fields_by_name[
        'key'
    ]._serialized_options = b'\372\336\037\030crypto/ed25519.PublicKey'
    ...
    _PRIVKEY.fields_by_name[
        'key'
    ]._serialized_options = b'\372\336\037\031crypto/ed25519.PrivateKey'
    _PRIVKEY._options = None
    _PRIVKEY._serialized_options = (
        b'\212\347\260*\031tendermint/PrivKeyEd25519\222\347\260*\tkey_field'
    )
