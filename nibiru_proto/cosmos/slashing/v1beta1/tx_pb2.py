...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.slashing.v1beta1.tx_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z-github.com/cosmos/cosmos-sdk/x/slashing/types\250\342\036\001'
    )
    _MSGUNJAIL.fields_by_name['validator_addr']._options = None
    _MSGUNJAIL.fields_by_name[
        'validator_addr'
    ]._serialized_options = b'\352\336\037\007address\322\264-\024cosmos.AddressString\242\347\260*\007address\250\347\260*\001'
    ...
    _MSGUPDATEPARAMS._serialized_options = (
        b'\202\347\260*\tauthority\212\347\260*%cosmos-sdk/x/slashing/MsgUpdateParams'
    )
    _MSG._options = None
