...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.auth.v1beta1.auth_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BASEACCOUNT.fields_by_name[
        ...
        b'\352\336\037\024public_key,omitempty\242\347\260*\npublic_key'
    )
    ...
    ]._serialized_options = b'\342\336\037\024SigVerifyCostED25519'
    _PARAMS.fields_by_name['sig_verify_cost_secp256k1']._options = None
    _PARAMS.fields_by_name[
        'sig_verify_cost_secp256k1'
    ]._serialized_options = b'\342\336\037\026SigVerifyCostSecp256k1'
    _PARAMS._options = None
    _PARAMS._serialized_options = (
        b'\350\240\037\001\212\347\260*\030cosmos-sdk/x/auth/Params'
    )
