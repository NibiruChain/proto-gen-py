...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.auth.v1beta1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYACCOUNTSRESPONSE.fields_by_name[
        'accounts'
    ]._serialized_options = b'\312\264-\034cosmos.auth.v1beta1.AccountI'
    _QUERYACCOUNTREQUEST.fields_by_name['address']._options = None
    _QUERYACCOUNTREQUEST.fields_by_name[
        'address'
    ...
    _QUERYMODULEACCOUNTSRESPONSE.fields_by_name[
        'accounts'
    ]._serialized_options = b'\312\264-\"cosmos.auth.v1beta1.ModuleAccountI'
    _QUERYMODULEACCOUNTBYNAMERESPONSE.fields_by_name['account']._options = None
    _QUERYMODULEACCOUNTBYNAMERESPONSE.fields_by_name[
        'account'
    ]._serialized_options = b'\312\264-\"cosmos.auth.v1beta1.ModuleAccountI'
    _QUERYACCOUNTADDRESSBYIDREQUEST.fields_by_name['id']._options = None
    _QUERYACCOUNTADDRESSBYIDREQUEST.fields_by_name[
        'id'
    ]._serialized_options = b'\030\001'
    _QUERYACCOUNTADDRESSBYIDRESPONSE.fields_by_name['account_address']._options = None
    _QUERYACCOUNTADDRESSBYIDRESPONSE.fields_by_name[
        'account_address'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _QUERYACCOUNTINFOREQUEST.fields_by_name['address']._options = None
    _QUERYACCOUNTINFOREQUEST.fields_by_name[
        'address'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _QUERY.methods_by_name['Accounts']._options = None
    _QUERY.methods_by_name[
        'Accounts'
    ]._serialized_options = b'\210\347\260*\001\202\323\344\223\002\037\022\035/cosmos/auth/v1beta1/accounts'
    _QUERY.methods_by_name['Account']._options = None
    _QUERY.methods_by_name[
        'Account'
    ]._serialized_options = b'\210\347\260*\001\202\323\344\223\002)\022\'/cosmos/auth/v1beta1/accounts/{address}'
    _QUERY.methods_by_name['AccountAddressByID']._options = None
    _QUERY.methods_by_name[
        'AccountAddressByID'
    ]._serialized_options = b'\210\347\260*\001\202\323\344\223\002)\022\'/cosmos/auth/v1beta1/address_by_id/{id}'
    _QUERY.methods_by_name['Params']._options = None
    _QUERY.methods_by_name[
        'Params'
    ]._serialized_options = (
        b'\210\347\260*\001\202\323\344\223\002\035\022\033/cosmos/auth/v1beta1/params'
    )
    _QUERY.methods_by_name['ModuleAccounts']._options = None
    _QUERY.methods_by_name[
        'ModuleAccounts'
    ]._serialized_options = b'\210\347\260*\001\202\323\344\223\002&\022$/cosmos/auth/v1beta1/module_accounts'
    _QUERY.methods_by_name['ModuleAccountByName']._options = None
    _QUERY.methods_by_name[
        'ModuleAccountByName'
    ]._serialized_options = b'\210\347\260*\001\202\323\344\223\002-\022+/cosmos/auth/v1beta1/module_accounts/{name}'
    _QUERY.methods_by_name['Bech32Prefix']._options = None
    _QUERY.methods_by_name[
        'Bech32Prefix'
    ]._serialized_options = (
        b'\202\323\344\223\002\035\022\033/cosmos/auth/v1beta1/bech32'
    )
    _QUERY.methods_by_name['AddressBytesToString']._options = None
    _QUERY.methods_by_name[
        'AddressBytesToString'
    ]._serialized_options = (
        b'\202\323\344\223\002-\022+/cosmos/auth/v1beta1/bech32/{address_bytes}'
    )
    _QUERY.methods_by_name['AddressStringToBytes']._options = None
    _QUERY.methods_by_name[
        'AddressStringToBytes'
    ]._serialized_options = (
        b'\202\323\344\223\002.\022,/cosmos/auth/v1beta1/bech32/{address_string}'
    )
    _QUERY.methods_by_name['AccountInfo']._options = None
    _QUERY.methods_by_name[
        'AccountInfo'
    ]._serialized_options = b'\210\347\260*\001\202\323\344\223\002-\022+/cosmos/auth/v1beta1/account_info/{address}'
