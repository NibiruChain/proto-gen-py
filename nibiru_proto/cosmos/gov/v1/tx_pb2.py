...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGSUBMITPROPOSAL._serialized_options = (
        b'\202\347\260*\010proposer\212\347\260*\037cosmos-sdk/v1/MsgSubmitProposal'
    )
    _MSGEXECLEGACYCONTENT.fields_by_name['content']._options = None
    _MSGEXECLEGACYCONTENT.fields_by_name[
        'content'
    ]._serialized_options = b'\312\264-\032cosmos.gov.v1beta1.Content'
    _MSGEXECLEGACYCONTENT._options = None
    _MSGEXECLEGACYCONTENT._serialized_options = (
        b'\202\347\260*\tauthority\212\347\260*\"cosmos-sdk/v1/MsgExecLegacyContent'
    )
    _MSGVOTE.fields_by_name['proposal_id']._options = None
    _MSGVOTE.fields_by_name[
        'proposal_id'
    ]._serialized_options = b'\352\336\037\013proposal_id\250\347\260*\001'
    ...
    _MSGVOTE._serialized_options = (
        b'\202\347\260*\005voter\212\347\260*\025cosmos-sdk/v1/MsgVote'
    )
    ...
    _MSGVOTEWEIGHTED._serialized_options = (
        b'\202\347\260*\005voter\212\347\260*\035cosmos-sdk/v1/MsgVoteWeighted'
    )
    ...
    _MSGDEPOSIT._serialized_options = (
        b'\202\347\260*\tdepositor\212\347\260*\030cosmos-sdk/v1/MsgDeposit'
    )
    ...
    _MSGUPDATEPARAMS._serialized_options = (
        b'\202\347\260*\tauthority\212\347\260*#cosmos-sdk/x/gov/v1/MsgUpdateParams'
    )
    _MSG._options = None
