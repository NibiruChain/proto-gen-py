...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.base.reflection.v1beta1.reflection_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z3github.com/cosmos/cosmos-sdk/client/grpc/reflection'
    )
    _REFLECTIONSERVICE.methods_by_name['ListAllInterfaces']._options = None
    _REFLECTIONSERVICE.methods_by_name[
        'ListAllInterfaces'
    ]._serialized_options = (
        b'\202\323\344\223\002,\022*/cosmos/base/reflection/v1beta1/interfaces'
    )
    _REFLECTIONSERVICE.methods_by_name['ListImplementations']._options = None
    _REFLECTIONSERVICE.methods_by_name[
        'ListImplementations'
    ]._serialized_options = b'\202\323\344\223\002M\022K/cosmos/base/reflection/v1beta1/interfaces/{interface_name}/implementations'
