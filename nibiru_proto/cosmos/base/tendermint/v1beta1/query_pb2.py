...
from cosmos.base.tendermint.v1beta1 import (
    types_pb2 as cosmos_dot_base_dot_tendermint_dot_v1beta1_dot_types__pb2,
)
...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.base.tendermint.v1beta1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z2github.com/cosmos/cosmos-sdk/client/grpc/tmservice'
    )
    ...
    _SERVICE.methods_by_name[
        ...
        b'\202\323\344\223\002+\022)/cosmos/base/tendermint/v1beta1/node_info'
    )
    _SERVICE.methods_by_name['GetSyncing']._options = None
    _SERVICE.methods_by_name[
        'GetSyncing'
    ]._serialized_options = (
        b'\202\323\344\223\002)\022\'/cosmos/base/tendermint/v1beta1/syncing'
    )
    _SERVICE.methods_by_name['GetLatestBlock']._options = None
    _SERVICE.methods_by_name[
        'GetLatestBlock'
    ]._serialized_options = (
        b'\202\323\344\223\002/\022-/cosmos/base/tendermint/v1beta1/blocks/latest'
    )
    _SERVICE.methods_by_name['GetBlockByHeight']._options = None
    _SERVICE.methods_by_name[
        'GetBlockByHeight'
    ]._serialized_options = (
        b'\202\323\344\223\0021\022//cosmos/base/tendermint/v1beta1/blocks/{height}'
    )
    ...
    _SERVICE.methods_by_name[
        ...
        b'\202\323\344\223\002,\022*/cosmos/base/tendermint/v1beta1/abci_query'
    )
