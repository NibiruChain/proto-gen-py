...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.upgrade.v1beta1.upgrade_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z,github.com/cosmos/cosmos-sdk/x/upgrade/types\310\341\036\000'
    )
    _PLAN.fields_by_name['time']._options = None
    _PLAN.fields_by_name[
        'time'
    ]._serialized_options = b'\030\001\310\336\037\000\220\337\037\001\250\347\260*\001'
    ...
    _PLAN._options = None
    _PLAN._serialized_options = (
        b'\230\240\037\000\350\240\037\001\212\347\260*\017cosmos-sdk/Plan'
    )
    _SOFTWAREUPGRADEPROPOSAL.fields_by_name['plan']._options = None
    _SOFTWAREUPGRADEPROPOSAL.fields_by_name[
        'plan'
