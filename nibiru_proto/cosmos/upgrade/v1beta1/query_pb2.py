...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.upgrade.v1beta1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name[
        ...
        b'\202\323\344\223\002&\022$/cosmos/upgrade/v1beta1/current_plan'
    )
    _QUERY.methods_by_name['AppliedPlan']._options = None
    _QUERY.methods_by_name[
        'AppliedPlan'
    ]._serialized_options = (
        b'\202\323\344\223\002-\022+/cosmos/upgrade/v1beta1/applied_plan/{name}'
    )
    _QUERY.methods_by_name['UpgradedConsensusState']._options = None
    _QUERY.methods_by_name[
        'UpgradedConsensusState'
    ]._serialized_options = b'\210\002\001\202\323\344\223\002@\022>/cosmos/upgrade/v1beta1/upgraded_consensus_state/{last_height}'
    _QUERY.methods_by_name['ModuleVersions']._options = None
    _QUERY.methods_by_name[
        'ModuleVersions'
    ]._serialized_options = (
        b'\202\323\344\223\002)\022\'/cosmos/upgrade/v1beta1/module_versions'
    )
    _QUERY.methods_by_name['Authority']._options = None
    _QUERY.methods_by_name[
        'Authority'
    ]._serialized_options = (
        b'\202\323\344\223\002#\022!/cosmos/upgrade/v1beta1/authority'
    )
