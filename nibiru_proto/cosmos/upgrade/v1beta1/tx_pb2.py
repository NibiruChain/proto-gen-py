...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'cosmos.upgrade.v1beta1.tx_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGSOFTWAREUPGRADE.fields_by_name[
        'authority'
    ...
    _MSGSOFTWAREUPGRADE._serialized_options = (
        b'\202\347\260*\tauthority\212\347\260*\035cosmos-sdk/MsgSoftwareUpgrade'
    )
    _MSGCANCELUPGRADE.fields_by_name['authority']._options = None
    _MSGCANCELUPGRADE.fields_by_name[
        'authority'
    ]._serialized_options = b'\322\264-\024cosmos.AddressString'
    _MSGCANCELUPGRADE._options = None
    _MSGCANCELUPGRADE._serialized_options = (
        b'\202\347\260*\tauthority\212\347\260*\033cosmos-sdk/MsgCancelUpgrade'
    )
    _MSG._options = None
