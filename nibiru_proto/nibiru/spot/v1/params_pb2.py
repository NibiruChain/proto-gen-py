...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'nibiru.spot.v1.params_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PARAMS.fields_by_name[
        'pool_creation_fee'
    ]._serialized_options = b'\310\336\037\000\362\336\037\030yaml:\"pool_creation_fee\"\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
    _PARAMS._options = None
    _PARAMS._serialized_options = b'\230\240\037\000'
    _globals['_PARAMS']._serialized_start = 129
    _globals['_PARAMS']._serialized_end = 388
