...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'nibiru.oracle.v1.event_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ORACLEPRICEUPDATE.fields_by_name[
        'price'
    ]._serialized_options = (
        b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
    )
    _globals['_ORACLEPRICEUPDATE']._serialized_start = 103
    _globals['_ORACLEPRICEUPDATE']._serialized_end = 247
