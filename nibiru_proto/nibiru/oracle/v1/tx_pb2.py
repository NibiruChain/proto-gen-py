...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'nibiru.oracle.v1.tx_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    ]._serialized_options = b'\202\323\344\223\002\030\"\026/nibiru/oracle/prevote'
    _MSG.methods_by_name['AggregateExchangeRateVote']._options = None
    _MSG.methods_by_name[
        'AggregateExchangeRateVote'
    ]._serialized_options = b'\202\323\344\223\002\025\"\023/nibiru/oracle/vote'
    _MSG.methods_by_name['DelegateFeedConsent']._options = None
    _MSG.methods_by_name[
        'DelegateFeedConsent'
    ]._serialized_options = b'\202\323\344\223\002 \"\036/nibiru/oracle/feeder-delegate'
    _globals['_MSGAGGREGATEEXCHANGERATEPREVOTE']._serialized_start = 100
    _globals['_MSGAGGREGATEEXCHANGERATEPREVOTE']._serialized_end = 275
    _globals['_MSGAGGREGATEEXCHANGERATEPREVOTERESPONSE']._serialized_start = 277
    _globals['_MSGAGGREGATEEXCHANGERATEPREVOTERESPONSE']._serialized_end = 318
    _globals['_MSGAGGREGATEEXCHANGERATEVOTE']._serialized_start = 321
    _globals['_MSGAGGREGATEEXCHANGERATEVOTE']._serialized_end = 559
    _globals['_MSGAGGREGATEEXCHANGERATEVOTERESPONSE']._serialized_start = 561
    _globals['_MSGAGGREGATEEXCHANGERATEVOTERESPONSE']._serialized_end = 599
    _globals['_MSGDELEGATEFEEDCONSENT']._serialized_start = 602
    _globals['_MSGDELEGATEFEEDCONSENT']._serialized_end = 734
    _globals['_MSGDELEGATEFEEDCONSENTRESPONSE']._serialized_start = 736
    _globals['_MSGDELEGATEFEEDCONSENTRESPONSE']._serialized_end = 768
    _globals['_MSG']._serialized_start = 771
    _globals['_MSG']._serialized_end = 1270
