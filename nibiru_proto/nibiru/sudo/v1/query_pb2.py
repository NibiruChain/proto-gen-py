...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'nibiru.sudo.v1.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYSUDOERSRESPONSE.fields_by_name[
        'sudoers'
    ]._serialized_options = b'\310\336\037\000'
    _QUERY.methods_by_name['QuerySudoers']._options = None
    _QUERY.methods_by_name[
        'QuerySudoers'
    ]._serialized_options = b'\202\323\344\223\002\026\022\024/nibiru/sudo/sudoers'
    _globals['_QUERYSUDOERSREQUEST']._serialized_start = 126
    _globals['_QUERYSUDOERSREQUEST']._serialized_end = 147
    _globals['_QUERYSUDOERSRESPONSE']._serialized_start = 149
    _globals['_QUERYSUDOERSRESPONSE']._serialized_end = 228
    _globals['_QUERY']._serialized_start = 231
