...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'nibiru.sudo.v1.event_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _EVENTUPDATESUDOERS.fields_by_name[
        'sudoers'
    ]._serialized_options = b'\310\336\037\000'
    _globals['_EVENTUPDATESUDOERS']._serialized_start = 126
    _globals['_EVENTUPDATESUDOERS']._serialized_end = 227
