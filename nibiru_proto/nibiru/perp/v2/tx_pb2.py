...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGREMOVEMARGIN.fields_by_name[
        'pair'
    ...
    _MSGMULTILIQUIDATE_LIQUIDATION.fields_by_name[
        'pair'
    ]._serialized_options = b'\310\336\037\000\332\336\0371github.com/NibiruChain/nibiru/x/common/asset.Pair'
    _MSGMULTILIQUIDATERESPONSE_LIQUIDATIONRESPONSE.fields_by_name[
        'liquidator_fee'
    ]._options = None
    _MSGMULTILIQUIDATERESPONSE_LIQUIDATIONRESPONSE.fields_by_name[
        'liquidator_fee'
    ]._serialized_options = b'\310\336\037\001'
    _MSGMULTILIQUIDATERESPONSE_LIQUIDATIONRESPONSE.fields_by_name[
        'perp_ef_fee'
    ]._options = None
    _MSGMULTILIQUIDATERESPONSE_LIQUIDATIONRESPONSE.fields_by_name[
    ...
    _MSGCLOSEPOSITION.fields_by_name[
        'pair'
    ]._serialized_options = b'\310\336\037\000\332\336\0371github.com/NibiruChain/nibiru/x/common/asset.Pair'
    ...
    _MSGDONATETOECOSYSTEMFUND.fields_by_name[
        'donation'
    ]._serialized_options = b'\310\336\037\000\362\336\037\017yaml:\"donation\"'
    _MSG.methods_by_name['RemoveMargin']._options = None
    _MSG.methods_by_name[
        'RemoveMargin'
    ]._serialized_options = (
        b'\202\323\344\223\002\037\"\035/nibiru/perp/v2/remove_margin'
    )
    _MSG.methods_by_name['AddMargin']._options = None
    _MSG.methods_by_name[
        'AddMargin'
    ]._serialized_options = b'\202\323\344\223\002\034\"\032/nibiru/perp/v2/add_margin'
    _MSG.methods_by_name['MultiLiquidate']._options = None
    _MSG.methods_by_name[
        'MultiLiquidate'
    ]._serialized_options = b'\202\323\344\223\002 \"\036/nibiru/perp/v2/multiliquidate'
    _MSG.methods_by_name['OpenPosition']._options = None
    _MSG.methods_by_name[
        'OpenPosition'
    ]._serialized_options = (
        b'\202\323\344\223\002\037\"\035/nibiru/perp/v2/open_position'
    )
    _MSG.methods_by_name['ClosePosition']._options = None
    _MSG.methods_by_name[
        'ClosePosition'
    ]._serialized_options = b'\202\323\344\223\002 \"\036/nibiru/perp/v2/close_position'
    _MSG.methods_by_name['DonateToEcosystemFund']._options = None
    _MSG.methods_by_name[
        'DonateToEcosystemFund'
    ]._serialized_options = (
        b'\202\323\344\223\002*\"(/nibiru/perp/v2/donate_to_ecosystem_fund'
    )
    _globals['_MSGREMOVEMARGIN']._serialized_start = 156
    _globals['_MSGREMOVEMARGIN']._serialized_end = 333
    _globals['_MSGREMOVEMARGINRESPONSE']._serialized_start = 336
    _globals['_MSGREMOVEMARGINRESPONSE']._serialized_end = 568
    _globals['_MSGADDMARGIN']._serialized_start = 571
    _globals['_MSGADDMARGIN']._serialized_end = 745
    _globals['_MSGADDMARGINRESPONSE']._serialized_start = 748
    _globals['_MSGADDMARGINRESPONSE']._serialized_end = 913
    _globals['_MSGMULTILIQUIDATE']._serialized_start = 916
    _globals['_MSGMULTILIQUIDATE']._serialized_end = 1160
    _globals['_MSGMULTILIQUIDATE_LIQUIDATION']._serialized_start = 1044
    _globals['_MSGMULTILIQUIDATE_LIQUIDATION']._serialized_end = 1160
    _globals['_MSGMULTILIQUIDATERESPONSE']._serialized_start = 1163
    _globals['_MSGMULTILIQUIDATERESPONSE']._serialized_end = 1522
    _globals['_MSGMULTILIQUIDATERESPONSE_LIQUIDATIONRESPONSE']._serialized_start = 1292
    _globals['_MSGMULTILIQUIDATERESPONSE_LIQUIDATIONRESPONSE']._serialized_end = 1522
    _globals['_MSGOPENPOSITION']._serialized_start = 1525
    _globals['_MSGOPENPOSITION']._serialized_end = 1965
    _globals['_MSGOPENPOSITIONRESPONSE']._serialized_start = 1968
    _globals['_MSGOPENPOSITIONRESPONSE']._serialized_end = 2708
    _globals['_MSGCLOSEPOSITION']._serialized_start = 2710
    _globals['_MSGCLOSEPOSITION']._serialized_end = 2831
    _globals['_MSGCLOSEPOSITIONRESPONSE']._serialized_start = 2834
    _globals['_MSGCLOSEPOSITIONRESPONSE']._serialized_end = 3332
    _globals['_MSGDONATETOECOSYSTEMFUND']._serialized_start = 3335
    _globals['_MSGDONATETOECOSYSTEMFUND']._serialized_end = 3465
    _globals['_MSGDONATETOECOSYSTEMFUNDRESPONSE']._serialized_start = 3467
    _globals['_MSGDONATETOECOSYSTEMFUNDRESPONSE']._serialized_end = 3501
    _globals['_MSG']._serialized_start = 3504
    _globals['_MSG']._serialized_end = 4323
