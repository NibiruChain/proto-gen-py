...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'nibiru.perp.v2.query_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYPOSITIONRESPONSE.fields_by_name[
        'position'
    ]._serialized_options = b'\310\336\037\000'
    ...
    _QUERYMODULEACCOUNTSRESPONSE.fields_by_name[
        'accounts'
    ]._serialized_options = b'\310\336\037\000'
    _ACCOUNTWITHBALANCE.fields_by_name['balance']._options = None
    _ACCOUNTWITHBALANCE.fields_by_name[
        'balance'
    ]._serialized_options = (
    ...
    _QUERYMARKETSRESPONSE.fields_by_name[
        'amm_markets'
    ]._serialized_options = b'\310\336\037\000'
    _QUERY.methods_by_name['QueryPosition']._options = None
    _QUERY.methods_by_name[
        'QueryPosition'
    ]._serialized_options = b'\202\323\344\223\002\032\022\030/nibiru/perp/v2/position'
    _QUERY.methods_by_name['QueryPositions']._options = None
    _QUERY.methods_by_name[
        'QueryPositions'
    ]._serialized_options = b'\202\323\344\223\002\033\022\031/nibiru/perp/v2/positions'
    _QUERY.methods_by_name['ModuleAccounts']._options = None
    _QUERY.methods_by_name[
        'ModuleAccounts'
    ]._serialized_options = (
        b'\202\323\344\223\002!\022\037/nibiru/perp/v2/module_accounts'
    )
    _QUERY.methods_by_name['QueryMarkets']._options = None
    _QUERY.methods_by_name[
        'QueryMarkets'
    ]._serialized_options = b'\202\323\344\223\002\031\022\027/nibiru/perp/v2/markets'
    _globals['_QUERYPOSITIONSREQUEST']._serialized_start = 158
    _globals['_QUERYPOSITIONSREQUEST']._serialized_end = 205
    _globals['_QUERYPOSITIONSRESPONSE']._serialized_start = 207
    _globals['_QUERYPOSITIONSRESPONSE']._serialized_end = 306
    _globals['_QUERYPOSITIONREQUEST']._serialized_start = 308
    _globals['_QUERYPOSITIONREQUEST']._serialized_end = 433
    _globals['_QUERYPOSITIONRESPONSE']._serialized_start = 436
    _globals['_QUERYPOSITIONRESPONSE']._serialized_end = 782
    _globals['_QUERYMODULEACCOUNTSREQUEST']._serialized_start = 784
    _globals['_QUERYMODULEACCOUNTSREQUEST']._serialized_end = 812
    _globals['_QUERYMODULEACCOUNTSRESPONSE']._serialized_start = 814
    _globals['_QUERYMODULEACCOUNTSRESPONSE']._serialized_end = 913
    _globals['_ACCOUNTWITHBALANCE']._serialized_start = 916
    _globals['_ACCOUNTWITHBALANCE']._serialized_end = 1085
    _globals['_AMMMARKET']._serialized_start = 1087
    _globals['_AMMMARKET']._serialized_end = 1197
    _globals['_QUERYMARKETSREQUEST']._serialized_start = 1199
    _globals['_QUERYMARKETSREQUEST']._serialized_end = 1220
    _globals['_QUERYMARKETSRESPONSE']._serialized_start = 1222
    _globals['_QUERYMARKETSRESPONSE']._serialized_end = 1310
    _globals['_QUERY']._serialized_start = 1313
    _globals['_QUERY']._serialized_end = 1854
