...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'nibiru.inflation.v1.inflation_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _INFLATIONDISTRIBUTION.fields_by_name[
        'staking_rewards'
    ]._serialized_options = (
    ...
    _EXPONENTIALCALCULATION.fields_by_name[
        'a'
    ]._serialized_options = (
        b'\310\336\037\000\332\336\037&github.com/cosmos/cosmos-sdk/types.Dec'
    )
    ...
    _globals['_INFLATIONDISTRIBUTION']._serialized_start = 83
    _globals['_INFLATIONDISTRIBUTION']._serialized_end = 377
    _globals['_EXPONENTIALCALCULATION']._serialized_start = 380
    _globals['_EXPONENTIALCALCULATION']._serialized_end = 590
