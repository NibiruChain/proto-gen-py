...
_MSGMULTILIQUIDATE = DESCRIPTOR.message_types_by_name['MsgMultiLiquidate']
_MSGMULTILIQUIDATE_MULTILIQUIDATION = _MSGMULTILIQUIDATE.nested_types_by_name['MultiLiquidation']
_MSGMULTILIQUIDATERESPONSE = DESCRIPTOR.message_types_by_name['MsgMultiLiquidateResponse']
_MSGMULTILIQUIDATERESPONSE_MULTILIQUIDATERESPONSE = _MSGMULTILIQUIDATERESPONSE.nested_types_by_name['MultiLiquidateResponse']
...
_MSGDONATETOECOSYSTEMFUND = DESCRIPTOR.message_types_by_name['MsgDonateToEcosystemFund']
_MSGDONATETOECOSYSTEMFUNDRESPONSE = DESCRIPTOR.message_types_by_name['MsgDonateToEcosystemFundResponse']
...
MsgMultiLiquidate = _reflection.GeneratedProtocolMessageType('MsgMultiLiquidate', (_message.Message,), {

  'MultiLiquidation' : _reflection.GeneratedProtocolMessageType('MultiLiquidation', (_message.Message,), {
    'DESCRIPTOR' : _MSGMULTILIQUIDATE_MULTILIQUIDATION,
    '__module__' : 'perp.v1.tx_pb2'
    # @@protoc_insertion_point(class_scope:nibiru.perp.v1.MsgMultiLiquidate.MultiLiquidation)
    })
  ,
  'DESCRIPTOR' : _MSGMULTILIQUIDATE,
  '__module__' : 'perp.v1.tx_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.perp.v1.MsgMultiLiquidate)
  })
_sym_db.RegisterMessage(MsgMultiLiquidate)
_sym_db.RegisterMessage(MsgMultiLiquidate.MultiLiquidation)

MsgMultiLiquidateResponse = _reflection.GeneratedProtocolMessageType('MsgMultiLiquidateResponse', (_message.Message,), {

  'MultiLiquidateResponse' : _reflection.GeneratedProtocolMessageType('MultiLiquidateResponse', (_message.Message,), {
    'DESCRIPTOR' : _MSGMULTILIQUIDATERESPONSE_MULTILIQUIDATERESPONSE,
    '__module__' : 'perp.v1.tx_pb2'
    # @@protoc_insertion_point(class_scope:nibiru.perp.v1.MsgMultiLiquidateResponse.MultiLiquidateResponse)
    })
  ,
  'DESCRIPTOR' : _MSGMULTILIQUIDATERESPONSE,
  '__module__' : 'perp.v1.tx_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.perp.v1.MsgMultiLiquidateResponse)
  })
_sym_db.RegisterMessage(MsgMultiLiquidateResponse)
_sym_db.RegisterMessage(MsgMultiLiquidateResponse.MultiLiquidateResponse)
...
MsgDonateToEcosystemFund = _reflection.GeneratedProtocolMessageType('MsgDonateToEcosystemFund', (_message.Message,), {
  'DESCRIPTOR' : _MSGDONATETOECOSYSTEMFUND,
  '__module__' : 'perp.v1.tx_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.perp.v1.MsgDonateToEcosystemFund)
  })
_sym_db.RegisterMessage(MsgDonateToEcosystemFund)

MsgDonateToEcosystemFundResponse = _reflection.GeneratedProtocolMessageType('MsgDonateToEcosystemFundResponse', (_message.Message,), {
  'DESCRIPTOR' : _MSGDONATETOECOSYSTEMFUNDRESPONSE,
  '__module__' : 'perp.v1.tx_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.perp.v1.MsgDonateToEcosystemFundResponse)
  })
_sym_db.RegisterMessage(MsgDonateToEcosystemFundResponse)
