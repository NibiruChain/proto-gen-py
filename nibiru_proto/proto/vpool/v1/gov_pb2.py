...
_EDITPOOLCONFIGPROPOSAL = DESCRIPTOR.message_types_by_name['EditPoolConfigProposal']
_EDITSWAPINVARIANTSPROPOSAL = DESCRIPTOR.message_types_by_name['EditSwapInvariantsProposal']
_EDITSWAPINVARIANTSPROPOSAL_SWAPINVARIANTMULTIPLE = _EDITSWAPINVARIANTSPROPOSAL.nested_types_by_name['SwapInvariantMultiple']
...
EditPoolConfigProposal = _reflection.GeneratedProtocolMessageType('EditPoolConfigProposal', (_message.Message,), {
  'DESCRIPTOR' : _EDITPOOLCONFIGPROPOSAL,
  '__module__' : 'vpool.v1.gov_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.vpool.v1.EditPoolConfigProposal)
  })
_sym_db.RegisterMessage(EditPoolConfigProposal)

EditSwapInvariantsProposal = _reflection.GeneratedProtocolMessageType('EditSwapInvariantsProposal', (_message.Message,), {

  'SwapInvariantMultiple' : _reflection.GeneratedProtocolMessageType('SwapInvariantMultiple', (_message.Message,), {
    'DESCRIPTOR' : _EDITSWAPINVARIANTSPROPOSAL_SWAPINVARIANTMULTIPLE,
    '__module__' : 'vpool.v1.gov_pb2'
    # @@protoc_insertion_point(class_scope:nibiru.vpool.v1.EditSwapInvariantsProposal.SwapInvariantMultiple)
    })
  ,
  'DESCRIPTOR' : _EDITSWAPINVARIANTSPROPOSAL,
  '__module__' : 'vpool.v1.gov_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.vpool.v1.EditSwapInvariantsProposal)
  })
_sym_db.RegisterMessage(EditSwapInvariantsProposal)
_sym_db.RegisterMessage(EditSwapInvariantsProposal.SwapInvariantMultiple)
