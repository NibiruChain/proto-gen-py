...
_SWAPONVPOOLEVENT = DESCRIPTOR.message_types_by_name['SwapOnVpoolEvent']
...
SwapOnVpoolEvent = _reflection.GeneratedProtocolMessageType('SwapOnVpoolEvent', (_message.Message,), {
  'DESCRIPTOR' : _SWAPONVPOOLEVENT,
  '__module__' : 'vpool.v1.event_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.vpool.v1.SwapOnVpoolEvent)
  })
_sym_db.RegisterMessage(SwapOnVpoolEvent)
