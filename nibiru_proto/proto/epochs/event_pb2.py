...
_EVENTEPOCHSTART = DESCRIPTOR.message_types_by_name['EventEpochStart']
_EVENTEPOCHEND = DESCRIPTOR.message_types_by_name['EventEpochEnd']
EventEpochStart = _reflection.GeneratedProtocolMessageType('EventEpochStart', (_message.Message,), {
  'DESCRIPTOR' : _EVENTEPOCHSTART,
  '__module__' : 'epochs.event_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.epochs.v1.EventEpochStart)
  })
_sym_db.RegisterMessage(EventEpochStart)

EventEpochEnd = _reflection.GeneratedProtocolMessageType('EventEpochEnd', (_message.Message,), {
  'DESCRIPTOR' : _EVENTEPOCHEND,
  '__module__' : 'epochs.event_pb2'
  # @@protoc_insertion_point(class_scope:nibiru.epochs.v1.EventEpochEnd)
  })
_sym_db.RegisterMessage(EventEpochEnd)
