...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, 'tendermint.p2p.types_pb2', _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:

    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = (
        b'Z1github.com/cometbft/cometbft/proto/tendermint/p2p'
    )
    ...
    _DEFAULTNODEINFOOTHER.fields_by_name[
        'rpc_address'
    ]._serialized_options = b'\342\336\037\nRPCAddress'
